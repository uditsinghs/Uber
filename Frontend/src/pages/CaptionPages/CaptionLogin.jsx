      ...
      <div className="min-h-screen flex  flex-col  items-center">
        <div className="bg-white p-8 rounded shadow-md w-full max-w-md">
          ...
          <div className="text-center mt-4">
            <span className="text-gray-600">Register as Caption </span>
            <Link
              to="/caption/register"
        ...
        <button
          onClick={handleRedirectUserLogin}
          type="submit"
          className=" mt-24 bg-orange-400 w-[80%] font-2xl text-white py-3 rounded hover:bg-green-800 transition duration-200"
        >
          Signup as a User
        </button>
      </div>
